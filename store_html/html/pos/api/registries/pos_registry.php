...
if (!function_exists('handle_pass_purchase')) {
    ...
    function handle_pass_purchase(PDO $pdo, array $config, array $input_data): void {
        ...
        // 4. 服务端校验 (依赖: pos_repo.php, pos_pass_helper.php)
